...
#ifndef XENSIV_BGT60TRXX_EDGE_H_
#define XENSIV_BGT60TRXX_EDGE_H_
...
#else
typedef mtb_hal_gpio_t               xensiv_bgt60trxx_mtb_interrupt_pin_t;
#endif
/** \endcond */
...
{
    CySCB_Type* scb_inst;
    cy_stc_scb_spi_context_t* spi;
    GPIO_PRT_Type* sel_port;
    uint32_t sel_pin;
...
#endif // ifndef XENSIV_BGT60TRXX_EDGE_H_

...
extern lv_anim_t * blue1anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * blue2anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * blue3anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * blue4anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * red1anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * red2anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * red3anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * red4anim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * fandragup_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * colonanim_Animation(lv_obj_t * TargetObject, int delay);
extern lv_anim_t * colonanimLP_Animation(lv_obj_t * TargetObject, int delay);
...
extern lv_anim_t * colomanimLP2_Animation(lv_obj_t * TargetObject, int delay);
...
LV_IMG_DECLARE(ui_img_mode_select_auto_png);    // assets/mode_select_auto.png
...
LV_IMG_DECLARE(ui_img_ble_adv__icon_img_png);    // assets/ble_adv__icon_img.png

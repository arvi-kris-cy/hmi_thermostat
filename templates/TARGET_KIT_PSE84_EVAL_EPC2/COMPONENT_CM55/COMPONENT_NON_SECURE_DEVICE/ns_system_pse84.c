...
void SystemInit(void)
{
    ...
    (void)Cy_SysClk_PeriGroupSetSlaveCtl(PERI_1_GROUP_1, CY_SYSCLK_PERI_GROUP_SL_CTL2, 0x0U); /* Suppress a compiler warning about unused return value */
    (void)Cy_SysClk_PeriGroupSetSlaveCtl(PERI_1_GROUP_2, CY_SYSCLK_PERI_GROUP_SL_CTL2, 0x0U); /* Suppress a compiler warning about unused return value */
    ...
    (void)Cy_SysClk_PeriGroupSetSlaveCtl(PERI_1_GROUP_1, CY_SYSCLK_PERI_GROUP_SL_CTL, 0xFFFFFFFFU); /* Suppress a compiler warning about unused return value */
    (void)Cy_SysClk_PeriGroupSetSlaveCtl(PERI_1_GROUP_2, CY_SYSCLK_PERI_GROUP_SL_CTL, 0xFFFFFFFFU); /* Suppress a compiler warning about unused return value */
#endif

...
#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define CYBSP_RS_SPI_CLK_DIV_HW CYHAL_CLOCK_BLOCK0_PERIPHERAL1_8BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */
...
#if defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE)
#define CYBSP_I2C_3V3_CLK_DIV_HW CYHAL_CLOCK_BLOCK0_PERIPHERAL1_8BIT
#endif /* defined (CY_USING_HAL) || defined (CY_USING_HAL_LITE) */
...
extern const cyhal_resource_inst_t CYBSP_RS_SPI_CLK_DIV_obj;
...
extern const cyhal_resource_inst_t CYBSP_I2C_3V3_CLK_DIV_obj;

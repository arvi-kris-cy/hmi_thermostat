...
#define CYBSP_RS_SPI_CLK_DIV_ENABLED 1U

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CYBSP_RS_SPI_CLK_DIV_HW CY_SYSCLK_DIV_8_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CYBSP_RS_SPI_CLK_DIV_NUM 0U
#define CYBSP_RS_SPI_CLK_DIV_GRP_NUM ((1U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CYBSP_RS_SPI_CLK_DIV_GRP_NUM)
#define CYBSP_RS_SPI_CLK_DIV_GRP_NUM CYBSP_RS_SPI_CLK_DIV_GRP_NUM
#endif /* !defined (CYBSP_RS_SPI_CLK_DIV_GRP_NUM) */
...
#define CYBSP_I2C_3V3_CLK_DIV_ENABLED 1U

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CYBSP_I2C_3V3_CLK_DIV_HW CY_SYSCLK_DIV_8_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CYBSP_I2C_3V3_CLK_DIV_NUM 4U
#define CYBSP_I2C_3V3_CLK_DIV_GRP_NUM ((1U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CYBSP_I2C_3V3_CLK_DIV_GRP_NUM)
#define CYBSP_I2C_3V3_CLK_DIV_GRP_NUM CYBSP_I2C_3V3_CLK_DIV_GRP_NUM
#endif /* !defined (CYBSP_I2C_3V3_CLK_DIV_GRP_NUM) */
...
#define CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_ENABLED 1U

#if !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE)
#define CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_HW CY_SYSCLK_DIV_16_BIT
#endif /* !defined (CY_USING_HAL) && !defined (CY_USING_HAL_LITE) */

#define CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_NUM 3U
#define CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM ((1U << PERI_PCLK_GR_NUM_Pos) | (0U << PERI_PCLK_INST_NUM_Pos))

#if !defined (CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM)
#define CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM
#endif /* !defined (CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM) */

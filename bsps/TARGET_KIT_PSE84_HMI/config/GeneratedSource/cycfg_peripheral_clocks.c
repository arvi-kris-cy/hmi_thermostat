...
void init_cycfg_peripheral_clocks(void)
{
    ...
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_I2C_3V3_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 4U, 31U);
    ...
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_GENERAL_PURPOSE_TIMER_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 2U, 65535U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_GENERAL_PURPOSE_TIMER_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 2U);
    Cy_SysClk_PeriPclkDisableDivider((en_clk_dst_t)CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 3U);
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 3U, 9U);
    Cy_SysClk_PeriPclkEnableDivider((en_clk_dst_t)CYBSP_PWM_DISP_BACKLIGHT_CLK_DIV_GRP_NUM, CY_SYSCLK_DIV_16_BIT, 3U);

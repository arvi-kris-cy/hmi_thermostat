...
#
# \brief
# Define the BSP for the KIT_PSE84_HMI
#
################################################################################
# \copyright
...
BSP_COMPONENTS:=HCI-UART WIFI_INTERFACE_SDIO SM GFXSS
...
BSP_DEFINES+=CYBSP_POST_CFG_INIT
...
MPN_LIST:=PSE846GPS2DBZC4A LBEE5HY2FY
DEVICE:=PSE846GPS2DBZC4A
ADDITIONAL_DEVICES:=CYW55513IUBG
BSP_DEVICE_SUPPORT_LIB:=mtb-dsl-pse8xxgp
DEVICE_COMPONENTS:=55500 55500A1 HCI-UART MURATA-2FY PSE84
